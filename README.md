...
![Last test](https://github.com/andrelohmann/ansible-role-vault/actions/workflows/test.yml/badge.svg)

## Content

Ansible role to install a single node instance of the hashicorp vault community edition.
...
The vault installation allows an automatic initialisation of the vault instance. The generated root and unseal tokens are stored in /opt/vault/tokens/tokens.json. Also an unseal script will be added to the vault.service unitfile, to unseal vault automatically on each restart command.
